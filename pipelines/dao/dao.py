...
class DAO:
    def __init__(self):
        if _config is None:
            raise ValueError("Config must be set before initializing DAO.")
    ...
    def get_assets(self, tickers: list[str]) -> AssetsDf:
    ...
    def get_betas(self, tickers: list[str]) -> BetasDf:
        betas = (
            sfd.load_assets_by_date(
    ...
    def get_ticker_barrid_mapping(self) -> pl.DataFrame:
    ...
    def get_benchmark_weights(self) -> WeightsDf:
        weights = (
            sfd.load_assets(
